...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/h3_Epic sadface Username is required'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_user-name'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/h4_Accepted usernames are'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_Accepted usernames arestandard_userlock_f87578'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/h4_Password for all users'))
