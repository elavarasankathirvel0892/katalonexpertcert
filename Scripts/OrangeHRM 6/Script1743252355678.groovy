...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/label_Username'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/label_Password'))
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_(61) Records Found'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_My Info'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/h6_manda user'))
