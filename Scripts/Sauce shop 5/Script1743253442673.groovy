...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_firstName'), 'Dhruv')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), 'Elavarasan')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postalCode'), '326548')
...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_Item total 129.94'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_Tax 10.40'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_Total 140.34'))
