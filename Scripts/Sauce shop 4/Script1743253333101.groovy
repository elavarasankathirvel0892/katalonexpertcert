...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/button_Cancel'))
...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/button_Remove_1_2_3'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/button_Remove_1_2_3_4'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/button_Remove_1_2_3_4_5'))
